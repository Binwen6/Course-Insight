...
*不同分类标准*
###### 有监督学习算法的分类
![这是图片](/src/discriminitive_vs_generative.jpg "contrast")
生成模型
...
1. 手动设计$\phi$,以人的经验选择特征，如边缘、HOG、SIFT
1. 自主学习$\phi$,从数据中挖掘和学习实现某一任务最佳$\phi(x)$ & 深度学习、神经网络属于此类。
